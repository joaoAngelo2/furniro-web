...
const ProductCard: React.FC<{ product: ProductCardProps }> = ({ product }) => {
  ...
  return (
    <div
      className="relative w-[17.8125rem] h-[27.875rem] flex flex-col group hover:shadow-lg transition-shadow duration-300 cursor-pointer"
    ...
    >
      ...
      <div className="w-[17.8125rem] h-[18.8125rem] flex-shrink-0 bg-gray-200 relative">
        <img
...
function ProductHintBall({ hint }: ProductHintProps) {
  ...
  const className = `flex justify-center items-center absolute rounded-[50%] top-2 right-2 w-[3rem] h-[3rem] ${color} z-10`;
